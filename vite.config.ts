    ...
    VitePWA({
      ...
      workbox: {
        ...
        globIgnores: [
          ...
          '**/CartesianChart-*.js',
          '**/CloudAccountRestorePanel-*.js',
          '**/DashboardCustomizationPage-*.js',
          '**/FavoriteMealsPage-*.js',
          '**/FoodProductsPage-*.js',
          '**/FriendsPrivacyPage-*.js',
          '**/guestDataImportService-*.js',
          '**/GuestDataImportPanel-*.js',
          '**/GlobalSearchPage-*.js',
          '**/GoalsPage-*.js',
          '**/OpenFoodFacts*.js',
          '**/PhotoNutritionEstimatePage-*.js',
          '**/photoNutritionAiClient-*.js',
          '**/PrivacyPage-*.js',
          '**/ProfilePage-*.js',
          '**/ProgressReportsPage-*.js',
          '**/Recipe*Page-*.js',
          '**/RewardsCenterPage-*.js',
          '**/RewardThemesPanel-*.js',
          '**/RoutineRemindersPage-*.js',
          '**/Settings*Page-*.js',
          '**/settings*.js',
          '**/StrengthExercise*Page-*.js',
