# Notes de publication — SportPilot 0.16.0

## Statut

SportPilot 0.16.0 est la version stable issue de la Release Candidate 0.16.0-rc.1 validée. Cette promotion ne modifie ni le schéma Dexie v2 ni le format de sauvegarde JSON v2.
...
- audit automatique du bundle en mode stable ;
...
- aucune dépendance npm supplémentaire pour la promotion stable.

## Validation avant publication

Avant le tag `v0.16.0` :
...
La checklist manuelle iPhone 15, les limitations connues et le test de mise à jour depuis 0.15.0 doivent également être validés.
