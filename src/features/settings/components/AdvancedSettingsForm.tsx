        ...
        <fieldset className="space-y-3">
          ...
          <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-slate-200 p-4 dark:border-slate-800">
            ...
            <span>
              ...
              <span className="mt-1 block text-sm leading-6 text-slate-600 dark:text-slate-300">Utilisée uniquement si le navigateur et l’appareil la prennent en charge.</span>
            </span>
          </label>
          <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-slate-200 p-4 dark:border-slate-800">
            ...
            <span>
              ...
              <span className="mt-1 block text-sm leading-6 text-slate-600 dark:text-slate-300">Le signal visuel et accessible reste toujours disponible si le son est bloqué.</span>
            </span>
          </label>
        </fieldset>
      </CollapsibleSection>
