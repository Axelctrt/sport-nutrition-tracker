  ...
  return (
    <div className="space-y-4">
      ...
      <InlineNotice tone="info" title="Réglages conservés sur cet appareil">
        Le thème clair ou sombre, le stockage, le minuteur de repos et les sauvegardes restent propres à cet appareil. Les thèmes de récompense et les rappels disposent désormais de leur synchronisation E2 séparée.
      </InlineNotice>
