import { Archive, Copy, Dumbbell, Layers3, LoaderCircle, Pencil, Plus, RotateCcw } from 'lucide-react';
import { useState } from 'react';
import { Link, useNavigate } from 'react-router-dom';
import { editWorkoutTemplatePath, routePaths } from '@/app/routePaths';
...
export function WorkoutTemplatesPage() {
  ...
  const { templates, status, errorMessage, actionId, refresh, setArchived, duplicate } = useWorkoutTemplates(includeArchived);
