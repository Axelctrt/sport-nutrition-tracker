...
describe('DashboardDailyCoachCard', () => {
  it.each([
    ...
    (verdict, title) => {
      render(<DashboardDailyCoachCard result={result(verdict, title)} />);
  ...
  it('n’affiche ni codes techniques, scores bruts, CTA, lien ni modal', () => {
  ...
  it('rend un fallback local accessible en cas d’indisponibilité', () => {
    render(<DashboardDailyCoachCard unavailable />);
