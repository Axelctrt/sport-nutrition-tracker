...
export function readSyncPrototypeConfig(
  ...
  return {
    ...
    realDailyCoachingSyncEnabled: readEnabledFlag(
      environment.VITE_ENABLE_REAL_DAILY_COACHING_SYNC,
    ...
    realSocialCloudEnabled: readEnabledFlag(
      environment.VITE_ENABLE_REAL_SOCIAL_CLOUD,
