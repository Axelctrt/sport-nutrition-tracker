...
describe('configuration du prototype Dexie Cloud', () => {
  ...
  it('verrouille la base et les quatre domaines sûrs contre une surcharge résiduelle du build', () => {
    const environment = mergeSyncPrototypeProductionEnvironment({
      ...
      VITE_ENABLE_REAL_ACTIVITY_SYNC: 'false',
  ...
  it('active séparément la synchronisation de la musculation', () => {
    expect(
      readSyncPrototypeConfig({
        VITE_ENABLE_SYNC_PROTOTYPE: 'true',
        VITE_DEXIE_CLOUD_DATABASE_URL:
  ...
  it('refuse une valeur ambiguë pour B3', () => {
    expect(() =>
      readSyncPrototypeConfig({
        VITE_ENABLE_SYNC_PROTOTYPE: 'true',
        VITE_DEXIE_CLOUD_DATABASE_URL: 'https://test.dexie.cloud',
        VITE_ENABLE_REAL_STRENGTH_SYNC: 'yes',
      }),
    ).toThrow('VITE_ENABLE_REAL_STRENGTH_SYNC');
  });
  ...
  it('active séparément la synchronisation du profil et des réglages', () => {
    expect(
      readSyncPrototypeConfig({
        VITE_ENABLE_SYNC_PROTOTYPE: 'true',
        VITE_DEXIE_CLOUD_DATABASE_URL:
  ...
  it('refuse une valeur ambiguë pour E1', () => {
    expect(() =>
      readSyncPrototypeConfig({
        VITE_ENABLE_SYNC_PROTOTYPE: 'true',
        VITE_DEXIE_CLOUD_DATABASE_URL: 'https://test.dexie.cloud',
  ...
  it('prépare séparément le flag de cloud social réel sans l’activer par défaut', () => {
    expect(
      readSyncPrototypeConfig({
        VITE_ENABLE_SYNC_PROTOTYPE: 'true',
        VITE_DEXIE_CLOUD_DATABASE_URL:
  ...
  it('refuse une valeur ambiguë pour le cloud social réel', () => {
    expect(() =>
      readSyncPrototypeConfig({
        VITE_ENABLE_SYNC_PROTOTYPE: 'true',
        VITE_DEXIE_CLOUD_DATABASE_URL: 'https://test.dexie.cloud',
