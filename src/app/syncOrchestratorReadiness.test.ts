...
describe('préparation F1 de l’orchestrateur de synchronisation 0.23.0', () => {
  it('conserve les versions de publication 0.23.0 pendant la construction du socle', () => {
    expect(__APP_VERSION__).toBe('0.23.0');
