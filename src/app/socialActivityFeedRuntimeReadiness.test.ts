...
describe('social activity feed runtime readiness 0.29.0 A21', () => {
  ...
  it('branche une interface verticale mobile-first sans exposer les identifiants métier', () => {
    ...
    expect(panelSource).toContain('socialActivityDetailMatchesFeedCard');
    expect(panelSource).toContain('detailRequestSequenceRef');
