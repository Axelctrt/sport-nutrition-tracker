...
if (failures.length === 0) {
  ...
  if (!cloud.includes('SYNC_PROTOTYPE_DATABASE_VERSION = 13')) {
    fail('Le runtime cloud doit passer en v13 pour les amitiés et permissions sociales.');
  }
}
...
console.log(
  'Audit E3 réussi : pilotage global, retour UX vers la rubrique, sélection de navigation unique, détail à la demande, reprise ciblée des échecs, historique isolé par compte et runtime cloud v13 social prêt.',
);
