...
if (!/^0\.(?:24|25|26|27|28)\.\d+$/.test(packageJson.version)) {
  fail(
    `le catalogue récompenses/thèmes 0.24.x à 0.28.x doit rester compatible avec la version applicative publiée, version trouvée : ${packageJson.version}.`,
  );
}
