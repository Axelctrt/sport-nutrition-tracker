...
if (!productionAudit.includes("totalJavaScriptBytes: 3356 * 1024")) {
  fail("le budget JavaScript de production doit rester borne a 3356 Kio.");
}
if (!productionAudit.includes("totalCssBytes: 176 * 1024")) {
  fail("le budget CSS de production doit rester fixe a 176 Kio.");
}
if (!automaticSyncReleaseAudit.includes("budget JavaScript global encadré de 3356 Kio")) {
