...
if (
  ...
  fail('package-lock.json ne correspond pas à la version 0.22.0.');
}
...
console.log(
  'Audit E4 réussi : SportPilot 0.22.0, neuf domaines cloud, restauration complète, centre unifié, isolation et versions de données validés.',
);
