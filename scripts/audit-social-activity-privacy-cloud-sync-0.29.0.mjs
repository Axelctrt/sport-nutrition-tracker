...
assert(appVersions.includes('CURRENT_DATABASE_VERSION = DATABASE_VERSION_10'), 'la version Dexie principale a été modifiée sans migration.');
assert(syncDatabase.includes('SYNC_PROTOTYPE_DATABASE_VERSION = 14'), 'la version du prototype cloud a été modifiée sans nécessité.');
