...
if (failures.length > 0) {
  ...
  console.log(
    'Audit final de synchronisation nutritionnelle réussi : journal atomique, bibliothèque cohérente, bilans et ajustements synchronisés, recalcul C1, isolation des comptes et runtime cloud v12 validés.',
  );
}
