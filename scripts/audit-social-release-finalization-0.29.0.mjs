...
check('release readiness version', releaseReadiness.includes("expect(__APP_VERSION__).toBe('0.31.0')"));
check('settings version', settingsTest.includes("getByText('0.31.0')"));
check('Open Food Facts user agent', openFoodFactsProxy.includes('SportPilot/0.31.0'));
